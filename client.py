...
# 创建多行文本框
listbox = ScrolledText(root, bg='pink')
...
def fileClient():
    ...
    # 创建列表框
    list2 = tkinter.Listbox(root, bg='NavajoWhite')
...
# 创建多行文本框, 显示在线用户
listbox1 = tkinter.Listbox(root,bg='Ivory')
...
# 创建发送按钮
button = tkinter.Button(root, bg='LightCyan' ,text='Send', command=send)
